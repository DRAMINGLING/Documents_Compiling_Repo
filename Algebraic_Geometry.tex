...
\begin{proof}
    ...
    \begin{equation*}
        \begin{tikzcd}
            & \mathcal{I} \arrow[rr, hookrightarrow] \arrow[dddr, "u"] &&
            \mathcal{C}^{0}(\mathcal{U}, \mathcal{I}) \arrow[dd, "\beta"] \arrow[dddl, "v"] \\
            \mathcal{F} \arrow[ur, hookrightarrow] \arrow[rr, hookrightarrow] \arrow[ddrr, hookrightarrow] &&
            \mathcal{C}^{0}(\mathcal{U}, \mathcal{F}) \arrow[ur, hookrightarrow] & \\

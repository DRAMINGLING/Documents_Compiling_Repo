...
\begin{proof}
    ...
    Define $\beta: \mathcal{C}^{i}(\mathcal{U}, \mathcal{I}) \rightarrow \mathcal{I}_{\mathcal{I}}^{i} = \mathcal{I}_{\mathcal{F}}^{i} \oplus \mathcal{I}_{\mathcal{G}}^{i}$ by
    \begin{equation*}
        \beta(U): s \longmapsto (\alpha(U)(s - ))
    \end{equation*}
    \par

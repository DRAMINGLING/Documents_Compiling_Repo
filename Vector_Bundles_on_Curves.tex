...
\begin{proof}
    ...
    Denote $\mathcal{G}_{i} := \pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{i}$ and $\mathcal{H}_{i} := \mathcal{I}_{Y}\pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{i}$ for $0 \le i \le r - 1$.
    By Hartshorne Chapter II exercise 5.15, we can extend $\mathcal{G}_{i}$ and $\mathcal{H}_{i}$ to coherent sheaves $\mathcal{G}_{i}'$ and $\mathcal{H}_{i}'$ on $\overline{\mathbb{P}(\mathcal{E})}$ respectively with $\mathcal{H}_{i}' \rightarrow \mathcal{G}_{i}'$ extending the natural map.
    \par
    ...
    \begin{equation}
        \begin{tikzcd}
            \cdots \arrow[r] &
            H^{1}(\overline{\mathbb{P}(\mathcal{E})}, \mathcal{H}_{i}'(m)) \arrow[r] \arrow[d, "\alpha"] &
            H^{1}(\mathbb{P}(\mathcal{E}), \mathcal{H}_{i}'(m)\big{|}_{\mathbb{P}(\mathcal{E})}) \arrow[r] \arrow[d, "\beta"] &
            H_{Z}^{2}(\overline{\mathbb{P}(\mathcal{E})}, \mathcal{H}_{i}'(m)) \arrow[r] \arrow[d] &
            \cdots \\
            \cdots \arrow[r] &

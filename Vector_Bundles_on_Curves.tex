...
\begin{proof}
    ...
    Then there is an open neighbourhood $U_{1, x}$ of $x$ such that $S^{n}\mathcal{E}\big{|}_{U_{1, x}}$ is globally generated.
    ...
    Then there is an open neighbourhood $U_{2, x}$ of $x$ such that $\mathcal{F} \otimes S^{i}\mathcal{E} \otimes \mathcal{E}\big{|}_{U_{2, x}}$ are globally generated.
    \par

...
\end{proposition}
\begin{proof}
    It is clear that if $\mathcal{E}_{1}$ and $\mathcal{E}_{2}$ are ample,
    then $\mathcal{E}_{1} \oplus \mathcal{E}_{2}$ is ample.
...
\begin{proof}
    ...
    \end{equation}
    Then by Proposition \ref{Proposition 4.9}, we know $\mathcal{E}_{1}^{\oplus r}$ is ample.

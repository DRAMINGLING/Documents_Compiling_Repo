...
\begin{proof}
    ...
    As $\mathcal{L}$ is ample, we find $r$ large enough such that $\mathcal{L}^{r}$ very ample with a closed immersion $\ell: \mathbb{P}(\mathcal{E}) \hookrightarrow \mathbb{P}$.
    \par
    Denote $\mathcal{G}_{j} = \ell_{\ast}(\pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{j})$ for $0 \le j \le r - 1$.
    By Projection Formula, it is equivalent to show $H^{0}(\mathbb{P}, \mathcal{G}_{j}(m)) \rightarrow H^{0}(\mathbb{P}, \mathcal{O}_{Y} \otimes \mathcal{G}_{j}(m))$ is surjective.
    ...
    Denote $Y := \pi^{-1}(x)$ and there is an short exact sequence.
    \begin{equation}
        0 \longrightarrow \mathcal{I}_{Y} \longrightarrow \mathcal{O}_{\mathbb{P}(\mathcal{E})} \longrightarrow \mathcal{O}_{Y} \longrightarrow 0
    \end{equation}
    Tensoring by $\pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{n}$, get exact sequence
    
    Hence suffices to show that $H^{1}(\mathbb{P}(\mathcal{E}), \mathcal{I}_{Y} \otimes \pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{n}) = 0$ for $n$ large enough,
    which immediately comes from Serre Theorem.
\end{proof}
\begin{remark}

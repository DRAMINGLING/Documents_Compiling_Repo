...
\begin{proof}
    ...
    \par
    When $X$ is projective, we may assume $\mathcal{F}$ is locally free.
    ...
    \begin{equation}
        0 \longrightarrow \mathcal{I}_{Y} \otimes \pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{n} \longrightarrow \pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{n} \longrightarrow \mathcal{O}_{Y} \otimes \pi^{\ast}\mathcal{F} \otimes \mathcal{L}^{n} \longrightarrow 0
    \end{equation}

...
\begin{proof}
    ...
    In this case, we have a natural surjective map $f^{\ast}f_{\ast}\mathcal{F} \twoheadrightarrow \mathcal{F}$ for all coherent sheaf $\mathcal{F}$,
...
\end{proof}
\begin{remark}
    When $f$ is not affine, then we cannot take affine cover such that $f^{\ast}f_{\ast}\mathcal{F}$ is of the form $M \otimes_{A} B$.
    So there is no natural surjection $f^{\ast}f_{\ast}\mathcal{F} \twoheadrightarrow \mathcal{F}$.
\end{remark}
\begin{proposition}

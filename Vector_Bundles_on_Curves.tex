...
\end{proof}
\begin{proposition}
    There is a functor $\theta: \vectorbundle_{X} \rightarrow \coherent (X)$ sending $E$ to $\mathcal{O}_{X}(E)$ and $E \rightarrow F$ to $\{\Gamma(U, E) \rightarrow \Gamma(U, F)\}$,
...
\begin{proof}
    ...
    \par
    Next to prover $\theta$ dense (or say essentially surjective) i.e. given $\mathcal{E}\in \coherent (X)$, there exists $E\in \vectorbundle_{X}$ with isomorphism $\mathcal{O}_{X}(E) \overset{\sim}{\rightarrow} \mathcal{E}$.

...
\begin{proposition}[\textbf{\emph{Local Criteria}}]
    Let $X$ be a variety, $\mathcal{E}$ vector bundle on $X$.
...
\begin{proof}
    ...
    Note that $X$ is a variety so that $U_{x}$ cover $X$ and there is a finite subcovering $U_{x_{1}}, \cdots, U_{x_{m}}$.
...
\end{remark}
\begin{proposition}
    Let $X$ be a scheme, $\mathcal{E}$ ample vector bundle on $X$.
...
\end{reason}
\begin{proposition}
    Let $X$ be a scheme, $\mathcal{E}_{1}$ and $\mathcal{E}_{2}$ vector bundles on $X$.
...
\end{proof}
\begin{corollary}
    Let $X$ be a scheme, $\mathcal{E}_{1}$ ample vector bundle on $X$.
...
\end{proof}
\begin{corollary}
    Let $X$ be a scheme, $\mathcal{E}_{1}$ and $\mathcal{E}_{2}$ ample vector bundles on $X$.
...
\end{proof}
\begin{proposition}
    Let $X$ be a scheme, $\mathcal{E}$ vector bundle on $X$.
...
\end{proof}
\begin{corollary}
    Let $X$ be a scheme, $\mathcal{E}$ vector bundle on $X$, $\mathcal{L}$ ample line bundle on $X$.
...
We claim that $\mathcal{E}$ is ample if and only if $\mathcal{O}_{\mathbb{P}(\mathcal{E})}(1)$ is ample line bundle on $\mathbb{P}(E)$,
where $\mathbb{P}(\mathcal{E}) \overset{\pi}{\rightarrow}$ is the projective bundle on $X$ associated to $\mathcal{E}$.
\begin{lemma}
    Let $X$ 

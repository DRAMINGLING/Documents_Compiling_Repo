...
\begin{proof}
    ...
    \begin{equation}
        \mathcal{O}_{C} \xrightarrow{s} \mathcal{E}
    \end{equation}
    Denote its image by $[s]$, which is a coherent subsheaf of $\mathcal{E}$.
    Since $\mathcal{E}$ is locally free, it is torsion free and so is $[s]$.
    As $C$ is a regular curve, $[s]$ is locally free of rank at most one.
\end{proof}
\begin{corollary}

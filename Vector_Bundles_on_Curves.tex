...
\begin{remark}
    ...
    Then define $\mathcal{O}_{X}(D) = \mathcal{O}_{X}(D_{1}) \otimes \mathcal_{X}(-D_{2})$.
...
\begin{proof}
    ...
    Want to use such a covering to compute cohomology.
    \par
    ...
    It is clear that $\Gamma(X, \ell_{\ast}\mathcal{O}_{X_{i}}(D)) \rightarrow \Gamma(U_{i}, \ell_{\ast}\mathcal{O}_{X_{i}}(D))$ is isomorphic.

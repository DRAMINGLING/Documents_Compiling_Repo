...
\end{remark}
\begin{lemma}
    The extension $0 \rightarrow \mathcal{E}' \rightarrow \mathcal{E} \overset{p}{\rightarrow} \mathcal{I}_{\mathcal{E}} \rightarrow 0$ is $\mathcal{I}_{\mathcal{E}}$-complete if and only if $p_{\ast}: H^{0}(X, \mathcal{E}) \to H^{0}(X, \mathcal{I}_{\mathcal{E}})$ is a zero map.
    \label{Lemma 5.11}
\end{lemma}
\begin{proof}
    If the extension is $\mathcal{I}_{\mathcal{E}}$-partial, then there is a commutative diagram
    \begin{equation}
        \begin{tikzcd}
            \mathcal{E} \arrow[r, "p"] &
            \mathcal{I}_{\mathcal{E}} \arrow[d, twoheadrightarrow, "q"] \\
            & \mathcal{E}'' \arrow[ul, "j"]
        \end{tikzcd}
    \end{equation}
    such that $q \circ p \circ j = \identity_{\mathcal{E}''}$.
    Hence $p_{\ast} \neq 0$ as $(q \circ p \circ j)_{\ast}$ is isomorphic.
    \par
    Conversely, if $p_{\ast} \neq 0$, then we can pick a nonzero section $s\in H^{0}(X, \mathcal{I}_{\mathcal{E}})$ such that $p_{\ast}s \neq 0$.
    Then $p_{\ast}s$ defines a line subbundle $[p_{\ast}s]$ of $\mathcal{I}_{\mathcal{E}}$.

...
\begin{proof}
    ...
    By Corollary \ref{Corollary 4.3}, $\mathcal{E} \otimes S^{n}\mathcal{E}$ is ample for $n$ large enough.
...
\end{corollary}
\begin{proof}
    First by Hartshorne Chapter II exercise 5.16, there is a filtration
    \begin{equation}

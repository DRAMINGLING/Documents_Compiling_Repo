...
\end{proposition}
\begin{proof}
    Consider exact sequence $0 \rightarrow \mathcal{O}_{\mathbb{P}_{\mathbb{C}}^{2}}(-n) \rightarrow \mathcal{O}_{\mathbb{P}_{\mathbb{C}}^{2}} \rightarrow \mathcal{O}_{C} \rightarrow 0$.

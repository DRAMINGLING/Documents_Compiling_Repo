...
Here the $\generallineargroup{r}{\mathbb{C}}$ is the open subset $D(\det)$ of $\mathbb{A}_{\mathbb{C}}^{n^{2}}$.
And there is an group action of $G$ on $R$ defined locally as following
\begin{equation}
    \begin{split}
        M: A \times \generallineargroup{r}{\mathbb{C}} & \rightarrow A \times \generallineargroup{r}{\mathbb{C}}
    \end{split}
\end{equation}
corresponding to the homomorphism defined by $M$.
\end{document}
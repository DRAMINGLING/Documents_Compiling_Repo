...
\begin{proposition}
    ...
    Then \\
    (1)$\mathcal{L}$ is ample if and only if $\deg \mathcal{L} > 0$. \\
    (2)For all coherent sheaf $\mathcal{F}$, there exists $n_{0}$ such that for all $\mathcal{L}$ with $\deg \mathcal{L} > n_{0}$,
